        ...
        <div class="card">
                ...
                <table class="table table-responsive-sm" id="myDataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <h5>{{ $data->where('order_id', $data->order_id)->sum('quantity') }} ต้น</h5>
                            </td>
                            <td>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-rounded btn-inverse-secondary btn-sm" data-toggle="modal"
                        data-target="#imageModal"><i class="mdi mdi-magnify"></i>ขยายใบเสร็จ
                    </button>
                    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('order.note', $data->order_id) }}">
                        <div><textarea class="form-control" cols="120" rows="5" placeholder="แจ้งหมายเหตุ"
                                name="order_note">{{ $data->order->order_note }}</textarea></div><br>
                        <input class="btn btn-rounded btn-inverse-success btn-md" type="submit" value="ยืนยัน">
                    </form>
                </div>
            </div>
        </div>
